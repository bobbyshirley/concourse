...
import {
  Users, UserCheck, Plane, Bus, X, Paperclip,
  MapPin, Utensils, Armchair, MessageSquare, StickyNote, Clock, Phone,
} from 'lucide-react';
...
export default function GuestOperations() {
  ...
  return (
    <>
      {/* Guest Table */}
      <div className="bg-[#0c0c0e] border border-zinc-800/80 rounded-lg overflow-hidden flex flex-col">
